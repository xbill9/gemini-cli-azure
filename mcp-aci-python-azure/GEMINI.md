...
The project is configured for deployment to **Azure Container Instance (ACI)** using Docker containers.
...
1.  **Deploy to Azure:** `make deploy`
    - This command handles ACR creation, image build, push, and ACI deployment.
