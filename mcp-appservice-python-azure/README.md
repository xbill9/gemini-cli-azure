# MCP HTTP Python Server for Azure App Service

A simple Model Context Protocol (MCP) server implemented in Python using `FastMCP`, optimized for deployment to **Azure App Service**. This server communicates over `HTTP` and serves as a foundational "Hello World" example for Python-based MCP integrations.
...
1.  **Clone the repository:**
    ...
    cd mcp-appservice-python-azure
    ```
...
The project includes a `Makefile` to automate deployment to Azure App Service using containers.
...
2.  **Deploy to Azure App Service:**
    ...
    *This command performs the following:*
    ...
    - Creates an App Service Plan and Web App if they don't exist.
    - Deploys the container to the Web App.
